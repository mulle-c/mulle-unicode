if( NOT __MULLE_UTF_DEPENDENCIES_AND_LIBRARIES_CMAKE__)
   set( __MULLE_UTF_DEPENDENCIES_AND_LIBRARIES_CMAKE__ ON)
   ...
   #
   #if( MSVC)
   #   set( MULLE_UTF_DEFINITIONS $<|PARENT_IDENTIFIER|>_DEFINITIONS})
   #endif()
endif()
